...
module.optionsTable = {
	...
	hideLOCBackground = {
		order = 2,
		type = "toggle",
		name = "Hide Loss of Control frame",
		desc = "Toggles \"Loss of Control\" frame from being hidden/shown",
		width = "full",
	},
	hideUIErrorsFrame = {
		order = 3,
		type = "toggle",
		name = "Hide UI errors",
		desc = "Hides/Shows UI errors such as out of range spells, no mana, and all others",
		width = "full",
	},
	hideBags = {
		order = 4,
		type = "toggle",
		name = "Hide Bags",
		desc = "Hides/Shows the Bags frame",
		width = "full",
	},
	hideMicroButtons = {
		order = 5,
		...
		desc = "Hides/Shows the Micro Buttons menu at the right corner of the UI",
		width = "full",
	},
	hideGlow = {
		order = 6,
		...
		desc = "Glow Effects on the outside world/arena from map features",
		width = "full",
	},
	hideEffects = {
		order = 7,
		type = "toggle",
		name = "Disable UI Effects",
		desc = "Effects from abilities and quests that mess with the screen, such as the blurry from mages' invisibility",
		width = "full",
	},
	header_minimap = {
		order = 8,
	...
	scrollZoom = {
		...
		desc = "Zoom in and out on minimap using only mousewheelup or down",
		width = "full",
	},
	header_automation = {
		order = 12,
	...
	sellGrays = {
		order = 13,
		type = "toggle",
		name = "Auto sell junk items",
		width = "full",
	},
	repair = {
		order = 14,
		type = "toggle",
		name = "Auto repair gear (equipped & bag)",
		width = "full",
	},
	header_arena = {
		order = 15,
	...
	dampeningDisplay = {
		...
		type = "toggle",
		name = "Dampening",
		desc = "Text at the top of the screen to indicate dampening percentage inside arenas",
		width = "full",
	},
}
